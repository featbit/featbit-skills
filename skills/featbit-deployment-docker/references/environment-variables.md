...
description: Core environment variables for FeatBit Docker Compose service configuration
---
...
9. [Troubleshooting Environment Variables](#troubleshooting-environment-variables)
...
For OpenTelemetry configuration, read `references/environment-variables-otel.md`.
